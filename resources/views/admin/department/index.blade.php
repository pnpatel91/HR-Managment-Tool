        ...
        <div class="row col-sm-12 page-titles">
            <div class="col-lg-5 p-b-9 align-self-center text-left  " id="list-page-actions-container">
                <div id="list-page-actions">
                    ...
                    <a href="{{ route('admin.department.create') }}" class="btn btn-danger btn-add-circle edit-add-modal-button js-ajax-ux-request reset-target-modal-form" id="popup-modal-button">
                        <span tooltip="Create new department." flow="right"><i class="fas fa-plus"></i></span>
                    </a>
                    @endcan
                    <!--ADD NEW BUTTON (link)-->
                </div>
            ...
            <div class="col-lg-7 align-self-center list-pages-crumbs text-right" id="breadcrumbs">
                ...
                <ol class="breadcrumb float-right">
                    ...
                    <li class="breadcrumb-item  active active-bread-crumb ">Departments</li>
                </ol>
                <!--crumbs-->
            </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">All Departments List</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
...
function datatables() {
    ...
    var table = $('#table').DataTable({
        ...
        ajax          : {
            url     : '{{ url('admin/department/ajax/data') }}',
            dataType: 'json'
        },
        columns       : [
